"""
Django settings for discord_auth_ex project.
...
SECRET_KEY = 'django-insecure-(zmk(=8oyw1o69jpjrxjty=)&wuzm-su)@u==c*l%@!io6ny^b'
...
ROOT_URLCONF = 'discord_auth_ex.urls'
...
WSGI_APPLICATION = 'discord_auth_ex.wsgi.application'
